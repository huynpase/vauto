...
namespace Vibz.Forms
{
	...
	public partial class MdiTabStrip : ToolStrip
	{
        ...
        private Image m_CloseBackgroundImage;
        ...
        /// <summary>
        /// Gets or sets the background image of the tab button.
        /// </summary>
        [
        Category("Appearance")
        ]
        ...
        {
            get { return m_ButtonBackgroundImage; }
            set
            {
                if (value == ButtonBackgroundImage)
                    return;
        ...
        /// <summary>
        /// Gets or sets the background image of the close button.
        /// </summary>
        [
        Category("Appearance")
        ]
        public Image CloseBackgroundImage
        {
            get { return m_CloseBackgroundImage; }
            set
            {
                if (value == CloseBackgroundImage)
                    return;

                m_CloseBackgroundImage = value;
                Invalidate();
            }
        }
